      ...
      >
        ...
        <TableContainer>
          <Table>
            <TableHead>
              <TableRow>
                <TableCell sx={{ fontWeight: "bold", color: "#013220" }}>Rank</TableCell>
                <TableCell sx={{ fontWeight: "bold", color: "#013220" }}>Name</TableCell>
                <TableCell sx={{ fontWeight: "bold", color: "#013220" }}>Points</TableCell>
              </TableRow>
            </TableHead>
            <TableBody>
              {paginatedData.map((entry, index) => {
                ...
                return (
                  ...
                  >
                    <TableCell sx={{ color: "#013220" }}>{globalIndex + 1}</TableCell>
                    <TableCell sx={{ color: "#013220" }}>
                      {entry.user.name} {isUser && "👈 You"}
                    </TableCell>
                    <TableCell sx={{ color: "#013220" }}>
                      {entry.sustainabilityPoints.toFixed(2)}
                    </TableCell>
                  </TableRow>
                );
              })}
